...
if __name__ == '__main__':
    ...
    dataset_train.initDB(img_dir='C:/Data/WIDERFACE_Dataset/train/images',
                         annotation_file='C:/Data/Widerface_Dataset/wider_face_split/wider_face_train_bbx_gt.txt')
    dataset_train.prepare()

    dataset_val = WiderFaceDataset()
    dataset_val.initDB(img_dir = 'C:/Data/Widerface_Dataset/val/images', annotation_file = 'C:/Data/Widerface_Dataset/wider_face_split/wider_face_val_bbx_gt.txt')
    dataset_val.prepare()   
    #anchors = generate_pyramid_anchors(config.RPN_ANCHOR_SCALES,
    #                                         config.RPN_ANCHOR_RATIOS,
    #                                         config.BACKBONE_SHAPES,
    ...
    #for i in range(100):
    #    print(i)
    #    image, image_meta, gt_class_ids, gt_boxes = load_image_gt(dataset_train, config, i, augment=False)
